App.WheelDirector = {
    ...
    getCategoryItem: function getCategoryItem(key) {
        var categories = this.initialCategories;
        for (i in categories) {
...
//        });
        ...
        $.each(categories, function (category) {
            $.each(category.items, function (item) {
        ...
        // build wheel
        $.each(wheelItems, function (index, item) {
